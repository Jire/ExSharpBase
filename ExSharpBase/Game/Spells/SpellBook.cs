...
namespace ExSharpBase.Game.Spells
{
    class SpellBook
    {
        ...
        public static int GetSpellBookInstance { get; } = Engine.GetLocalPlayer + OffsetManager.Instances.SPELL_BOOK;
        ...
        private static bool IsSpellReady(SpellSlot Slot)
        {
            SpellSlotID FindSlotID =
                (SpellSlotID) Enum.Parse(typeof(SpellSlotID), Enum.GetName(typeof(SpellSlot), Slot));
